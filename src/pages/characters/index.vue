<template>
  <v-container>
    ...
    <v-card v-if="characters.length === 0" border class="pa-6">
      <v-row justify="center">
        <v-col align="center">
          <v-icon class="mb-3 text-medium-emphasis" icon="mdi-account-off-outline" size="64" />
...
<script setup lang="ts">
  ...
  import { type CharacterShort, useCharacterStore } from '@/stores/characterStore.ts'
